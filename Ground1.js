var Ground1 = {
	preload: function(){
		...
		text = game.add.text(0, 0, "LEVEL 1", style);
 text.setShadow(3, 3, 'rgba(0,0,0,0.5)', 2);
		...
		this.load.spritesheet('pole', 'assets/pole.png', 16, 16);
		this.load.spritesheet('blackhole', 'assets/teleport.png', 16, 16);
		this.load.tilemap('level', 'assets/2016201.json', null,
	...
	create: function(){
		...
		map.createFromTiles(12, null, 'pole', 'stuff',poles);
	...
	update: function(){
		...
		game.physics.arcade.overlap(player, poles, poleOverlap);
