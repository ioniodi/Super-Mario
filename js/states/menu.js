...
Game.menuState.prototype = {
    create:function(game) {
        ...
        var playB = buttonManager.createButton(game,"Play", true, game.width / 3, (game.height / 2)+10, menuButtonSize.width, menuButtonSize.height, function() {
            buttonManager.buttonState(game, max_level, 'play');
        }, buttonFrame.menu_button, 0.85, false);
        
        var levelsB = buttonManager.createButton(game, "Levels", true, 2.7*game.width / 4, (game.height / 2)+10, menuButtonSize.width, menuButtonSize.height, function() {
            buttonManager.buttonState(game, 0, 'choose_level');
        }, buttonFrame.menu_button, 0.85, false);
       
        var helpB = buttonManager.createButton(game, "Help", true, game.width / 3, (game.height / 2) + 50, menuButtonSize.width, menuButtonSize.height, function() {
            buttonManager.buttonState(game, 0, 'help');
        }, buttonFrame.menu_button, 0.85, false);

        var settingsB = buttonManager.createButton(game, "Settings", true, 2.7*game.width / 4, (game.height / 2) + 50, menuButtonSize.width, menuButtonSize.height, function() {
