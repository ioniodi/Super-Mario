...
Game.choose_levelState.prototype = {
    create:function(game) {
        ...
        var level_zero_B = buttonManager.createButton(game, "0", false, 40, 40, levelButtonSize.width, levelButtonSize.height, function() {
        ...
        var level_one_B = buttonManager.createButton(game, "1", false, 80, 40, levelButtonSize.width, levelButtonSize.height, function() {
            soundManager.playSound(game, clickS);
            currentLevel = levelManager.checkLevelAvailability(game, 1, levelLocked[1]);
        }, levelLocked[1], 0.85, false);
        
        var level_two_B = buttonManager.createButton(game, "2", false, 120, 40, levelButtonSize.width, levelButtonSize.height, function() {
            soundManager.playSound(game, clickS);
            currentLevel = levelManager.checkLevelAvailability(game, 2, levelLocked[2]);
        }, levelLocked[2], 0.85, false);

        var level_three_B = buttonManager.createButton(game, "3", false, 160, 40, levelButtonSize.width, levelButtonSize.height, function() {
            soundManager.playSound(game, clickS);
            currentLevel = levelManager.checkLevelAvailability(game, 3, levelLocked[3]);
        }, levelLocked[3], 0.85, false);
        
        var playB = buttonManager.createButton(game, "play", true, game.width - 18, 10, 30, 20, function() {
