var Stage1 = {
		...
		create: function() {
			...
			portal = game.add.sprite(1450, game.world.height - 200, 'portal');
			game.physics.arcade.enable(portal);
			portal.body.gravity.y = 0;
			portal.body.enable = true;
			portal.animations.add('spin', [ 0, 1, 2], 3, true);
			...
			crab.callAll('animations.add', 'animations', 'walk', [ 0, 1 ], 2, true);
		...
		update: function() {
			...
			game.physics.arcade.overlap(player, portal, portalOverlap);
