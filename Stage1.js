var Stage1 = {
		...
		create: function() {
			...
			portal1 = game.add.sprite(1050, game.world.height - 200, 'portal');
			game.physics.arcade.enable(portal1);
			portal1.body.gravity.y = 0;
			portal1.body.enable = true;
			portal1.animations.add('spin', [ 0, 1, 2], 6, true);
			...
			crab.callAll('animations.add', 'animations', 'walk', [ 0, 1 ], 4, true);
			...
			goombas.callAll('animations.add', 'animations', 'walk', [ 0, 1 ], 4, true);
			goombas.callAll('animations.play', 'animations', 'walk');
			goombas.setAll('body.bounce.x', 1);
			goombas.setAll('body.velocity.x', -30);
			goombas.setAll('body.gravity.y', 500);

			door1 = game.add.sprite(2000, game.world.height - 112, 'door');
			game.physics.arcade.enable(door1);
			door1.body.gravity.y = 0;
			door1.body.enable = true;
		...
		update: function() {
			...
			game.physics.arcade.overlap(player, door1, door1Overlap);
			game.physics.arcade.overlap(player, crab, crabOverlap);
			game.physics.arcade.overlap(player, portal1, portal1Overlap);
