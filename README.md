...
- Ένα βασικό πρόβλημα είναι ότι το ανέβασμα και η αποθήκευση assets (πίστες, εικόνες) και sounds είναι επί πληρωμή. Για να το ξεπεράσουμε θα χρησιμοποιήσουμε τα github pages για το ανέβασμα και την αποθήκευση των επιπλέον assets και sounds που θα χρησιμοποιήσεις για τις επεκτάσεις.
...
![ScreenShot](/settings_img/1.png)

- Τέλος φόρτωσε την εικόνα από το Github Pages κάνοντας τις κατάλληλες αλλαγές στο [index.html](index.html). 
![ScreenShot](2.png)
